  ...
  Widget build(BuildContext context) {
    ...
    if (_currentTab == 1) {
      ...
      body = ListView(
        ...
        children: [
          ...
          Slider(
            value: widget.vibrancy,
            min: 0,
            max: 0.4,
            divisions: 8,
            label: widget.vibrancy.toStringAsFixed(2),
            onChanged: widget.onVibrancy,
          ),
          ...
          ExpressiveButtonGroup(
            selectedIndex: ExpressiveShapeType.values.indexOf(widget.shape),
            onSelected: (i) => widget.onShape(ExpressiveShapeType.values[i]),
            buttons: const [
    ...
    return Scaffold(
      appBar: _currentTab == 0
          ...
          : null,
      endDrawer: _currentTab == 0 ? const TokenInspector() : null,
      body: body,
      bottomNavigationBar: Theme(
        data: theme.copyWith(
          navigationBarTheme: ExpressiveNavBarTheme.morphing(scheme: scheme),
        ),
        child: NavigationBar(
